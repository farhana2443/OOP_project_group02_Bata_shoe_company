...
public class PDFHelperModelClass {
    ...
    public static <T> void generatePDF(String filePath, String title, String[] columnHeaders, List<T> data, Function<T, String>[] extractors) throws IOException, DocumentException {
